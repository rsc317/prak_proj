...
<section>
    ...
    <form name="myDataForm" id="myDataForm" action="include/mydata.inc.php" method="post">
        ...
        <input  type="text" name="street_name" id="street_name"  placeholder="<?php echo $_SESSION['street_name']; ?>">

        <label for="street_number">Number</label>
        <input  type="text" name="street_number" id="street_number"  placeholder="<?php echo $_SESSION['street_number']; ?>">
        ...
        <input  type="number" name="phone_number" id="phone_number"  placeholder="<?php  echo $_SESSION['phone_number']; ?>">
    ...
    if(isset($_GET['error'])) {
        ...
        if  ($_GET['error'] == 'emailAlreadyExists') {
            ...
            echo '<p>Data has been changed</p>';
        }
    }
    ?>
</section>
